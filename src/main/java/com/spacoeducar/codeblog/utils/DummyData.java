package com.spacoeducar.codeblog.utils;
...
public class DummyData {
	...
	@Autowired
	CodeBlogRepository codeBloRepository;
	...
	public void savePosts() {
		...
		Post post1 = new Post();
		post1.setAutor("Bianca Souza");
		post1.setData(LocalDate.now());
		post1.setTitulo("Angular");
		...
		Post post2 = new Post();
		post2.setAutor("Fernando Paz");
		post2.setData(LocalDate.now());
		post2.setTitulo("Spring Boot e Spring Framework");
		...
		for(Post post: postList) {
			Post postSaved = codeBloRepository.save(post);
